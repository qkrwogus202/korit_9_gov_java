...
public class ComplexSalaryCalculatorSolution {
        ...
        public static void main(String[] args) {
            ...
            double yearRate = workYears < 3 ? 0.0 :
                    workYears < 7 ? 0.05 : workYears < 15 ? 0.1 : 0.2;
//            // 연차수당 계산 (기본급 기준 %)
...
//            // 야근수당 계산
            ...
            int overtimePayment = isOverTime ?
                    ((overtimeHours - 10) * 15000) + (10 * 10000) : 0;
//
//            // 특별보너스 계산
...
//            // 직급명 출력용
            ...
            System.out.println(String.format("연차수당: %원", yearAllowance));
