...
public class Operator05 {
    public static void main(String[] args) {
        ...
        int year = 1900; // 2024년, 2000년 윤년
        //윤년인지 확인하세요. (4의 배수이면서 100의 배수가 아니거나) 또는 400의 배수
        String result = (year % 4 == 0 && year % 100 != 0) || year % 400 ==0 ? "윤년입니다." : "평년입니다.";;
//        String result1 = (1999 % 4 == 0) && (1999 % 100 != 0) || (1999 % 400 == 0) ? "윤년입니다." : "평년입니다.";
//        String result2 = (2024 % 4 == 0) && (1999 % 100 != 0) || (2024 % 400 == 0) ? "윤년입니다." : "평년입니다.";
...
//        String 상태 = 현재잔액-(출금금액 + 수수료) < 0 ? "성공" : "실패"; //성공/실패
//        int 출금액 = 현재잔액-(출금금액 + 수수료) < 0 ? 0 : (출금금액 + 1000);    //수수료 1000원 포함
